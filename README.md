...
In this modified repo, it includes `helper_math.h` in `src` directory downloaded from the repo [CUDA Samples repository](https://github.com/NVIDIA/cuda-samples)
